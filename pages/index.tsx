...
export default function Home() {
  ...
  async function start() {
    ...
    setPlays([]); setTotals([0,0,0]); setFinished(0); setLog([]); setWinner(null); setDelta(null);
              ...
              try {
                ...
                if (m.type === 'event' && m.kind === 'play') {
                  if (m.move === 'pass') {
                    ...
                    nextHands[m.seat] = nextHands[m.seat].slice().filter((x)=>!cards.includes(x) || (cards.splice(cards.indexOf(x),1), false));
