...
// thresholds for both built-ins and external choices
...
const __thMapChoice: Record<string, number> = {
  ...
  // external AI / HTTP models (default slightly steady)
  'external':              2.2,
  'external:ai':           2.2,
  'external:http':         2.2,
  'ai':                    2.2,
...
if (rob) {
        __bidders.push({ seat: s, score: sc, threshold: __th, margin: score: sc - __th  });
